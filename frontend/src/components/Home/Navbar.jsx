    ...
    <nav className="w-full bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="max-w-8xl mx-auto h-[80px] flex items-center justify-between px-5 lg:px-10 ">
        ...
        <div className="flex items-center gap-4 cursor-pointer">
          ...
          <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white text-xl font-bold"> </div>
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <Link to="/Upload" className="flex items-center gap-2 font-semibold hover:text-indigo-600 transition">
            <Upload size={18} />
            Upload
          </Link>
