    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <button className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-semibold shadow w-full cursor-pointer sm:w-auto">
            <Upload size={18} />
            Upload PDF
          </button>

          <button className="flex items-center cursor-pointer justify-center gap-2 border border-gray-300 hover:bg-gray-100 px-6 py-3 rounded-xl font-semibold w-full sm:w-auto">
